...
var (
	...
	// TBCMainnetChainConfig is the chain parameters to run a node on the Tbc main network.
	TbcMainnetChainConfig = &ChainConfig{
		ChainID:             big.NewInt(20192019),
	...
	// TBCTestnetChainConfig is the chain parameters to run a node on the Tbc test network.
	TbcTestnetChainConfig = &ChainConfig{
		ChainID:             big.NewInt(198907),
		HomesteadBlock:      big.NewInt(0),
		DAOForkBlock:        nil,
		DAOForkSupport:      false,
		EIP150Block:         big.NewInt(0),
		EIP150Hash:          common.HexToHash("0xd9e7ed10f755e5e34b0d8c887cfd62de7634c4443c30c3f2097fe1b32e9a0dfd"),
		EIP155Block:         big.NewInt(0),
		EIP158Block:         big.NewInt(0),
		ByzantiumBlock:      big.NewInt(0),
		ConstantinopleBlock: nil,
